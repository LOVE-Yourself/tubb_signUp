...
var _LoadingHtml = '<div id="loadingDiv" style="position:absolute;left:0;width:100%;height:' + _PageHeight + 'px;top:0;background: rgb(255,255,255);opacity:1;filter:alpha(opacity=80);z-index:10000;"><div style="position: absolute; cursor1: wait; left: ' + _LoadingLeft + 'px; top:' + _LoadingTop + 'px; width: 397px; height: 389px; line-height: 57px; padding-left: 50px; padding-right: 5px; background: rgb(255,255,255) url(/images/Loading.gif) no-repeat scroll 5px 10px; color: #696969; font-family:\'Microsoft YaHei\';"><!--Loading...  --></div></div>';
//呈现loading效果
