...
class Course(models.Model):
    ...
    detail1 = models.TextField(verbose_name=u'费用详情')
    detail2 = models.TextField(verbose_name=u'赠送课时')
    cost_new = models.CharField(max_length=20,verbose_name=u'现价')
    cost_old = models.CharField(max_length=20,verbose_name=u'原价')
